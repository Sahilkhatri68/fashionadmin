...
function OrderDetail_processing() {
    return (
        <div>
            <div>
                ...
                <div className='mt-4 '>
                    <div className='flex justify-end text-center  items-center'>
                        ...
                        <div className="m-[10px]">
                            <select className='border border-[#262626] p-[12px] text-[#D67D3E] rounded-l-[5px] '>
                                <option value="PROCESSING" className='text-[#D67D3E] font-bold'>PROCESSING</option>
                                <option value="CANCEL" className='text-[#D61C4E] font-bold'>CANCEL</option>
                                <option value="READY" className='text-[#D62AD0] font-bold'>READY</option>

                            </select>
                            <button className='bg-[#262626] text-white p-[11px] border border-[#262626]  rounded-r-[5px] '>Apply</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="lg:w-full lg:mr-2 h-full bg-white shadow-md p-5 pb-[45px] ">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="mt-6 mr-10">
                                ...
                                <p className="text-[#000000] mb-[4px]">Status: <span className='text-[#D67D3E] font-bold'>PROCESSING</span>  </p>
                                <p className="text-[#000000] mb-[4px]">Order Date: <span className='text-[#000000] font-bold'> 23-02-2022 04:34 PM</span>  </p>
                                <p className="text-[#000000] mb-[4px]">Payement: <span className='text-[#A760FF] font-bold'> UNPAID</span>  </p>
                                <p className="text-[#000000] mb-[4px]">Payement Code: <span className='text-[#A760FF] font-bold'> COD</span>  </p>
...
export default OrderDetail_processing